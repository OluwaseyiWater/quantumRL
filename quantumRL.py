...
class QuantumPolicyGradient:
    ...
    def plot_performance(self):
        ...
        plt.xlabel('Episode'); plt.ylabel('Reward'); plt.title('Quantum Training Progress')
...
if __name__=='__main__':
    def main(num_episodes=500, seed=None):
        ...
        rewards=agent.train(num_episodes=num_episodes,print_interval=25,seed=seed)
        agent.plot_performance()  # Added to display training plot
        return rewards
    main()
