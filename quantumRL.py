...
class QuantumSingleQubitEnv(gym.Env):
    ...
    def apply_noise(self):
        ...
        # # Rest of your existing noise code...
        # # [Keep existing depolarizing/amplitude damping implementation]
...
class QuantumPolicyGradient:
    ...
    #     if policy_loss:  # Only proceed if we have loss terms
...
def main():
    ...
    agent.train(num_episodes=500, print_interval=25)
    
    print("Training complete. Plotting performance...")
